...
class JiepaiSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        article_list = bsp.select('.articleCell.SG_j_linedot1')
        count = 0
        title =""
        for article in article_list:
            ...
            # if count ==4:
            #     break
            link_title = article.select('.atc_title > a')
        ...
        for jie_pai_detail in jie_pai_detail_links:
            ...
            if 'photo.blog.sina.com.cn' in link_content:
                ...
                if img_height > img_width:
                    ...
                    logging.info(
                    'jie_pai_detail img_width: ' + str(img_width) + ' img_height: ' + str(img_height) + ' img_src: ' + img_src + ' img_desc: ' + img_desc)
                else:
